...
if(isset($_POST['login'])){
	...
	if(empty($_POST['email']) OR empty($_POST['password'])){
		...
		if($user){
			...
			$loginMessage = "Mauvais identifiants ou Mauvais mot de passe ";
		}
	}
}
...
if(isset($_POST['register'])){
    ...
    elseif($_POST['password'] != $_POST['password_confirm']) {
        ...
        $query = $db->prepare('INSERT INTO user (firstname,lastname,email,password,adresse) VALUES (?, ?, ?, ?, ?)');
...
<html>
 ...
 <body class="article-body">
	<div class="container-fluid">
        ...
        <?php require 'partials/header.php'; ?> <br/><br/>

        <div class="row my-3 article-content" style="margin-left: 18%">
					...
					<div class="tab-pane container-fluid <?php if(isset($_POST['register'])): ?>active<?php endif; ?>" id="register" role="tabpanel">
						...
						<form action="login-register.php" method="post" class="p-4 row flex-column">
							...
							<div class="form-group col-sm-8 offset-sm-2">
								...
								<textarea class="form-control" name="adresse" id="adresse" placeholder="adresse + ville + département"></textarea>
							</div>

                            <div class="form-group col-sm-8 offset-sm-2">
                                <label for="mobile"> Mobile <b class="text-danger">*</b> </label>
                                <textarea class="form-control" name="mobile" id="mobile" placeholder="numéro de téléphone"></textarea>
                            </div>
